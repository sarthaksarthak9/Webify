...
export function CTA({ heading, subheading, buttonText }: CTAProps) {
    return (
        <section className="relative w-full py-20 sm:py-28 md:py-32 px-4 sm:px-8 bg-[#1B243F] text-white text-center overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="px-8 sm:px-10 md:px-12 py-4 sm:py-5 bg-[#4ADE80] text-[#1B243F] rounded-full text-base sm:text-lg md:text-xl font-bold shadow-2xl transition-all duration-300"
                >
                    {buttonText}
                </motion.button>
            </div>
